class PythonAT2718 < Formula
  ...
  bottle do
    sha256 monterey: "3e44d51d17c628491783b525b3a1f7ceb24dccc20ad55141b591ff824525bce5"
  end
  ...
  def install
    ...
    if MacOS.version < :catalina
      ...
      inreplace "setup.py" do |s|
        s.gsub! "dep_target = sysconfig.get_config_var('MACOSX_DEPLOYMENT_TARGET')", "dep_target = str(sysconfig.get_config_var('MACOSX_DEPLOYMENT_TARGET'))"
      end

      inreplace "./Lib/distutils/spawn.py" do |s|
        s.gsub! "_cfg_target = sysconfig.get_config_var(", "_cfg_target = str(sysconfig.get_config_var("
        s.gsub! "'MACOSX_DEPLOYMENT_TARGET') or ''", "'MACOSX_DEPLOYMENT_TARGET')) or ''"
      end
    end
